...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Out-2024 às 21:48
...
INSERT INTO `treinos` (`nomeTreino`, `descricaoTreino`, `data_inicioTreino`, `data_fimTreino`, `nivelTreino`, `duracaoTreino`, `objetivosTreino`, `urlTreino`, `fotoTreino`) VALUES
('treino passe', 'talvez dê errado', '2024-10-04', '2024-10-05', 'Basico', '01:30', 'apreder lguma coisa', 'https://www.youtube.com/watch?v=paBHsq0lBcM&ab_channel=SIKANABrasil%2FPortugu%C3%AAs', 'img/passeTreino.jpg');
