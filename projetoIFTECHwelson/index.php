...
<?php
    ...
    if($totalTreinos > 0){
        ...
        while($registro = mysqli_fetch_assoc($res)){
            ...
            $nivelTreino = $registro["nivelTreino"];
            $tipoTreino = $registro["tipoTreino"];
            $objetivosTreino = $registro["objetivosTreino"];
            ...
            <div class='col-4' style='margin-bottom:30px;'>
                <div class='card' style='width:100%; height:100%; border-radius: 15px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);'>
                    ...
                    <div class='card-body text-center'>
                        ...
                        <h6 class='card-title' style='color: #6c757d;'>dificuldade: $nivelTreino</h6>
                        <div class='container mt-3 text-center'>
                            <img src='$foto' width='150' title='Foto de $nomeTreino' style='border-radius: 25px; transition: transform 0.2s;'>
                        </div>
                        <h5 class='card-title' style='color: #6c757d;'>Objetivo do Treino: $objetivosTreino</h5>
                        <h5 class='card-title' style='color: #6c757d;'>Tipo de Treino: $tipoTreino</h5>
