...
<?php
    ...
    $objetivosTreino = $_POST['objetivosTreino'];
    ...
    $sql = "INSERT INTO treinos (fotoTreino, nomeTreino, descricaoTreino, data_inicioTreino, data_fimTreino, nivelTreino, duracaoTreino, objetivosTreino, urlTreino, tipoTreino)
            VALUES ('$fotoTreino', '$nome', '$descricao', '$dataInicio', '$dataFim', '$nivelTreino', '$duracao', '$objetivosTreino', '$urlTreino', '$tipoTreino')";
